...
function EventComponent({cssVariables}) {
  const data = useParams();
  console.log(data);
  console.log(cssVariables);
  return (
    <div id="loader" style={cssVariables}>
    {data.clubName === "plexus" && <svg
        width="100"
        height="100"
        viewBox="0 0 458 299"
        fill="white"
    ...
    {data.clubName === "plexus" &&       <div class="bg">
      ...
      { data.clubName === "innovista" && <img src="https://www.innovista.in/static/images/inno.jpg" height="100px" width="100px" alt="" />}
      { data.clubName === "nss" && <img src="https://upload.wikimedia.org/wikipedia/commons/9/90/NSS-symbol.jpeg" height="100px" width="100px" alt="" />}
      { data.clubName !== "innovista" && data.clubName !== "plexus" && data.clubName !== "nss" && (<img src="https://mrce.in/assets/images/logo.png" height="100px" width="100px" alt="" />) }
      <div class="dots">
        <div></div>
        <div></div>
        <div></div>
